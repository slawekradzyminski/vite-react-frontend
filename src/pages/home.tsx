      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 md:col-span-2">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">Application Features</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-green-50 rounded-lg p-5">
                ...
                <Button onClick={() => navigate('/users')} variant="outline" className="w-full border-green-600 text-green-700 hover:bg-green-100">
                  Manage Users
                </Button>
              </div>
              ...
              <div className="bg-purple-50 rounded-lg p-5">
                ...
                <Button onClick={() => navigate('/profile')} variant="outline" className="w-full border-purple-600 text-purple-700 hover:bg-purple-100">
                  View Profile & Orders
                </Button>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">Advanced Monitoring</h2>
            ...
            <div className="mb-6 p-4 bg-amber-50 rounded-lg border border-amber-200">
              ...
              <Button onClick={() => navigate('/traffic')} variant="outline" className="w-full border-amber-600 text-amber-700 hover:bg-amber-100">
          ...
          {/* AI Integration */}
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">AI Integration</h2>
        ...
        <div className="mt-6 bg-white rounded-lg shadow-md p-6">
          <h2 className="text-xl font-semibold text-gray-800 mb-4">Additional Utilities</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="border border-gray-200 rounded-lg p-4">
              ...
              <Button onClick={() => navigate('/qr')} variant="outline" className="w-full border-gray-400">
                Generate QR Codes
              </Button>
            </div>
            <div className="border border-gray-200 rounded-lg p-4">
              ...
              <Button onClick={() => navigate('/email')} variant="outline" className="w-full border-gray-400">
                Send Emails
              </Button>
            </div>
          </div>
