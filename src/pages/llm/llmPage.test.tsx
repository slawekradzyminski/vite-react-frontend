  ...
  OllamaChatPage: () => (
    <div data-testid="ollama-chat-page" className="flex flex-col">
      ...
      <div data-testid="temperature-control" className="mb-4">
        ...
        <input data-testid="temperature-slider" id="temperature" type="range" className="w-full" min="0" max="1" step="0.1" value="0.8" onChange={() => {}} />
      ...
      <div data-testid="chat-input-container" className="flex items-end gap-2">
        <textarea data-testid="chat-input" className="flex-1 border rounded p-2 resize-none" rows={2} placeholder="Type your message..." readOnly />
  ...
  OllamaGeneratePage: () => (
    <div data-testid="ollama-generate-page" className="flex flex-col">
      ...
      <div data-testid="prompt-container" className="mb-4">
        ...
        <textarea data-testid="prompt-input" id="prompt" className="w-full border rounded p-2 resize-none" rows={4} placeholder="Enter your prompt..." readOnly />
      </div>
