...
describe('useOllama', () => {
  ...
  it('processes successful response', async () => {
    ...
    const mockResponse = new Response(
      'data: {"model":"qwen3.5:2b","response":"Hello","done":false}\n\n' +
      'data: {"model":"qwen3.5:2b","response":" World","done":true}\n\n',
      {
        headers: { 'Content-Type': 'text/event-stream' }
      }
    );
  ...
  it('processes thinking content in response', async () => {
    // given
    const mockResponse = new Response(
      'data: {"model":"qwen3.5:2b","response":"","thinking":"Let me think...","done":false}\n\n' +
      'data: {"model":"qwen3.5:2b","response":"","thinking":" about this.","done":false}\n\n' +
      'data: {"model":"qwen3.5:2b","response":"Hello","thinking":"","done":false}\n\n' +
      'data: {"model":"qwen3.5:2b","response":" World","thinking":"","done":true}\n\n',
      {
        headers: { 'Content-Type': 'text/event-stream' }
      }
    );
  ...
  it('processes response with thinking enabled', async () => {
    // given
    const mockResponse = new Response(
      'data: {"model":"qwen3.5:2b","response":"Answer","thinking":"Reasoning","done":true}\n\n',
      {
        headers: { 'Content-Type': 'text/event-stream' }
      }
    );
